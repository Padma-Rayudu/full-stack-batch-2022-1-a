  ...
  return (
    <div>
      ...
      <div className="search-container p-2 mx-auto mt-3" >
          ...
          <div className="dropdown">
            {
              ...
              users.filter((f) => {
                ...
                const mailid = f.email.toLowerCase()
                return (searchterm && mailid.startsWith(searchterm) && mailid != searchterm);

              })
                .map((f) => {
                  return (
                    <div onClick={() => onSearch(f.email)}>
                      {f.email}
                    </div>
                  )
                })
        ...
        <div className="mx-auto m-5 p-5" style={{ marginTop: "10px" }}>
