...
export default function Choice() {
    ...
    <nav class="nav flex-column">
       ...
       <Link to='/showactivities' className="nav-link active" style={{textDecoration:"none"}}><i class="bi bi-clipboard-check"></i>&nbsp;Activities</Link>
            ...
            <div className='m-5 card p-5  mx-auto sh ' style={{ width: '600px',height:"200px"}}>
                <label className="form-label" htmlFor="fullname">Whom do you want to create Expense ?</label>
                <div className='d-flex '>
                    <div className='form check'>
                        <input type="radio" className='form-check-input me-2' name="choice" value="friends" onChange={(e) => { settype(e.target.value) }}/>
                        <label class="form-check-label">Friends </label>
                    </div>&nbsp;&nbsp;&nbsp;
                    <div>
                        <input type="radio" className='form-check-input me-2' name="choice" value="groups" onChange={(e) => { settype(e.target.value) }} />
                        <label class="form-check-label" >Groups</label>
                    </div>
                </div>
                <div>
                    <Link to="/myexpenses" style={{textDecoration:"none" ,marginTop:"50px"}}><i class="bi bi-arrow-left"></i>Back</Link>
                    <button className="btn btn-primary mt-3" style={{ width: '100px', float: "right" }} type="submit" onClick={handlesumbit}>
                        Continue
                    </button>
                </div>
            </div>
